...
class TipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tip" do
    assert_difference('Tip.count') do
      post tips_url, params: { tip: { content: @tip.content, good_count: @tip.good_count, type_id: @tip.type_id, user_id: @tip.user_id } }
    end
  ...
  test "should update tip" do
    patch tip_url(@tip), params: { tip: { content: @tip.content, good_count: @tip.good_count, type_id: @tip.type_id, user_id: @tip.user_id } }
